...
- **Trigger blocks**: CloudTrail events, security group changes, IAM policy modifications, S3 public access changes, cost anomalies
- **Action blocks**: Query AWS resources, describe instances, check security groups, generate Terraform fixes, create PRs for IaC remediation
