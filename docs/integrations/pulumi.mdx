...
<Steps>
  ...
  <Step title="Register webhooks (for triggers)">
    ...
    2. In Pulumi Cloud, open your organization's **Settings → Webhooks** (or a stack's **Settings → Webhooks**) and click **Create webhook**.
    3. Set the **Payload URL** to the copied webhook URL and paste the webhook secret as the **Secret**.
    4. Select the event groups you want (stack events, update events, deployment events, drift events, policy events).
  </Step>
</Steps>
