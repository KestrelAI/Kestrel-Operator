...
<Steps>
  ...
  <Step title="Register webhooks (for triggers)">
    ...
    5. Under **Triggers**, check these boxes so every Kestrel trigger block receives its events:
       ...
       - **Environment events** and **Change requests** are not consumed by Kestrel and can be left unchecked.
