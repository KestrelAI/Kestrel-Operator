...
# AWS Cost
Action.aws_query_cost_explorer().aws_account("380983552929").time_range("30d")
Action.aws_get_cost_anomalies().aws_account("380983552929")
Action.aws_get_cost_forecast().aws_account("380983552929")
Action.aws_get_budget_status().aws_account("380983552929")
