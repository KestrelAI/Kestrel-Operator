...
<CardGroup cols={2}>
  ...
  <Card title="Custom HTTP" icon="globe">
    Call any API endpoint with custom HTTP action blocks. See [Custom Integrations](/workflows/custom-integrations).
  </Card>
</CardGroup>
...
| No cooldown | 0 | — |
| 5 minutes | 5m | — |
| 10 minutes | 10m | Slack, PostHog, Vercel, custom webhook triggers |
| 30 minutes | 30m | — |
| 1 hour | 1h | — |
| 3 hours | 3h | — |
| 12 hours | 12h | — |
