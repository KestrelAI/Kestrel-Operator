...
The integration usage chart shows which integrations are used most frequently across all workflow executions. Each bar represents an integration (Slack, GitHub, Jira, Kestrel RCA, etc.) with the total number of action executions.
