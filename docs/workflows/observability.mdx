...
| **Trigger Sources** | Breakdown of executions by trigger type (K8s, Cloud, Slack, PagerDuty, PostHog, Vercel, Railway, Fly.io, Nebius, Pulumi Cloud, Webhook) |
...
| **Trigger Source** | K8s Incident, Cloud Signal, Slack, PagerDuty, PostHog, Vercel, Railway, Fly.io, Nebius, Pulumi Cloud, Webhook |
