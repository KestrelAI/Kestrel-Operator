...
type NetworkPolicy struct {
	...
	Action        Action `protobuf:"varint,4,opt,name=action,proto3,enum=cloud.v1.Action" json:"action,omitempty"` // CREATE, UPDATE, DELETE
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_cloud_v1_message_proto_rawDesc = string([]byte{
	...
	0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x22, 0xc7, 0x01, 0x0a, 0x0d, 0x4e, 0x65, 0x74, 0x77, 0x6f,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x10, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x76,
	...
	0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x2a, 0x59, 0x0a, 0x06, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x03, 0x32, 0x5e, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x01, 0x42, 0x74, 0x0a, 0x0c, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x76,
	0x31, 0x42, 0x0c, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
	0x01, 0x5a, 0x15, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x2f, 0x61, 0x70, 0x69, 0x2f,
	0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2f, 0x76, 0x31, 0xa2, 0x02, 0x03, 0x43, 0x58, 0x58, 0xaa, 0x02,
...
var file_cloud_v1_message_proto_depIdxs = []int32{
	...
	0,  // 21: cloud.v1.NetworkPolicy.action:type_name -> cloud.v1.Action
	23, // 22: cloud.v1.ObjectMeta.labels:type_name -> cloud.v1.ObjectMeta.LabelsEntry
	24, // 23: cloud.v1.ObjectMeta.annotations:type_name -> cloud.v1.ObjectMeta.AnnotationsEntry
	14, // 24: cloud.v1.NetworkPolicySpec.pod_selector:type_name -> cloud.v1.LabelSelector
	16, // 25: cloud.v1.NetworkPolicySpec.ingress:type_name -> cloud.v1.NetworkPolicyIngressRule
	17, // 26: cloud.v1.NetworkPolicySpec.egress:type_name -> cloud.v1.NetworkPolicyEgressRule
	25, // 27: cloud.v1.LabelSelector.match_labels:type_name -> cloud.v1.LabelSelector.MatchLabelsEntry
	15, // 28: cloud.v1.LabelSelector.match_expressions:type_name -> cloud.v1.LabelSelectorRequirement
	18, // 29: cloud.v1.NetworkPolicyIngressRule.from:type_name -> cloud.v1.NetworkPolicyPeer
	20, // 30: cloud.v1.NetworkPolicyIngressRule.ports:type_name -> cloud.v1.NetworkPolicyPort
	18, // 31: cloud.v1.NetworkPolicyEgressRule.to:type_name -> cloud.v1.NetworkPolicyPeer
	20, // 32: cloud.v1.NetworkPolicyEgressRule.ports:type_name -> cloud.v1.NetworkPolicyPort
	14, // 33: cloud.v1.NetworkPolicyPeer.pod_selector:type_name -> cloud.v1.LabelSelector
	14, // 34: cloud.v1.NetworkPolicyPeer.namespace_selector:type_name -> cloud.v1.LabelSelector
	19, // 35: cloud.v1.NetworkPolicyPeer.ip_block:type_name -> cloud.v1.IPBlock
	1,  // 36: cloud.v1.StreamService.StreamData:input_type -> cloud.v1.StreamDataRequest
	6,  // 37: cloud.v1.StreamService.StreamData:output_type -> cloud.v1.StreamDataResponse
